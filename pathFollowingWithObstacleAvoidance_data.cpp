//
// File: pathFollowingWithObstacleAvoidance_data.cpp
//
...
P_pathFollowingWithObstacleAvoidance_T pathFollowingWithObstacleAvoidance_P = {
  ...
  // Computed Parameter: Ranges_Y0
  //  Referenced by: '<S1>/Ranges'

  0.0,

  // Computed Parameter: Angles_Y0
  ...
  // Computed Parameter: CurrentPose_Y0
